...
M.streams = {
  ...
  research_modules = { icon_tech="modules", groups = {
    ...
    { change=0.01, item_patterns={"%-module%-4$","mega%-module","merge%-module","omni%-module","ultimate%-module","%-module$"} }
  }},
  ...
  research_concrete = { icon_tech = "concrete", groups = { { change = 0.10, items = { "stone-brick" } }, { change = 0.05, items = { "concrete", "hazard-concrete" } }, { change = 0.02, items = { "refined-concrete", "refined-hazard-concrete" } } } },
